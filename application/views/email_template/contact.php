...
<h1 style="width:100%; padding:0px 0px 30px 0px; margin:0px; color:#e4097f; font-size:30px; font-weight:bold; clear:both;"><?php echo $first_name;?>, please find contact details</h1>
