...
<a href="<?php echo base_url('product-list/'.$enity_list[1]->slug);?>">
...
<a href="<?php echo base_url('product-list/'.$enity_list[2]->slug);?>">
...
<a href="<?php echo base_url('product-list/'.$enity_list[3]->slug);?>">
...
<a href="<?php echo base_url('product-list/'.$enity_list[4]->slug);?>">
...
<span class="name"><?php echo ucfirst($enity_list[4]->name);?></span> 

<span class="disc"><?php echo $enity_list[4]->description;?></span> 
...
<div class="news-letter-content">Subscribe to sareewali mailing list to receive updates on new arrivals, special offers and other discount information.</div>
...
<div class="policy-content"><span>Excluding Shipping Charges due to COVID-19</span>all over India</div>
