      ...
      <div class="rTableRow">
        ...
        <div class="rTableCell productQuantity">
          ...
          <span class="input-group-btn">
            ...
            <button class="btn btn-primary" title="Increase" onclick="update_cart('increase', '<?php echo $value->cart_id;?>', '<?php echo $value->prd_slug;?>');"><i class="fa fa-plus"></i></button>

            <button class="btn btn-danger" title="Decrease" onclick="update_cart('decrease', '<?php echo $value->cart_id;?>', '<?php echo $value->prd_slug;?>');"><i class="fa fa-minus" aria-hidden="true"></i></button>
