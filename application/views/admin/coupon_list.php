								 ...
								 <div class="col-sm-6">
									<form action="<?php echo base_url('admin/coupon-list');?>" method="GET" role="form">
										<div id="dataTables-example_filter" class="dataTables_filter">
											<label>Search by:<input name="code" type="search" class="form-control input-sm" placeholder="Code" aria-controls="dataTables-example" id="user-search" value="<?php echo $search_key;?>"></label>
								 ...
								 <div class="col-sm-12">
									<table width="100%" class="table table-striped table-bordered table-hover dataTable no-footer dtr-inline" id="dataTables-example" role="grid" aria-describedby="dataTables-example_info" style="width: 100%;">
									   ...
									   <tbody>
										...
										<?php foreach($coupon_details AS $detail) {?>
										  <tr class="gradeA odd" role="row">
											 ...
											 <td class="center">
												<a href="<?php echo base_url('admin/coupon-edit/'.$detail->coupon_id);?>" class="btn btn-success" title="Edit">Edit</a>&nbsp;
												<?php
													if($detail->status == 'Y'){
												?>
												<a href="javascript:void(0);" onclick="onDeleteConfirm('<?php echo base_url('admin/coupon/coupon_update/'.$detail->coupon_id);?>');" class="btn btn-danger" title="Delete">Delete<a>						<?php
													}
												?>						
											</td>
										  </tr>
