...
<div style=" display:block; max-width:80%; clear:both; padding:15px 0px 0px 0px; margin:0px auto;">
  ...
  <h2  style="width:100%; padding:0px 0px 20px 0px; margin:0px; color:#615e5e; font-size:20px; font-weight:normal; clear:both;">Hi, your product is available now:</h2>
        ...
        <table class="purchase_content" width="100%" cellpadding="0" cellspacing="0" style="box-sizing: border-box; font-family: Arial, 'Helvetica Neue', Helvetica, sans-serif; margin: 0; padding: 25px 0 0; width: 100%;">
          <tr>
            <th class="purchase_heading" style="border-bottom-color: #EDEFF2; border-bottom-style: solid; border-bottom-width: 1px; box-sizing: border-box; font-family: Arial, 'Helvetica Neue', Helvetica, sans-serif; padding-bottom: 8px;">
              <p style="box-sizing: border-box; color: #9BA2AB; font-family: Arial, 'Helvetica Neue', Helvetica, sans-serif; font-size: 12px; line-height: 1.5em; margin: 0;" align="left">&nbsp;</p>
            </th>
            <th class="purchase_heading" style="border-bottom-color: #EDEFF2; border-bottom-style: solid; border-bottom-width: 1px; box-sizing: border-box; font-family: Arial, 'Helvetica Neue', Helvetica, sans-serif; padding-bottom: 8px;">
...
<div style=" width:100%; display:block;max-width:80%; clear:both; padding:0 0px 32px 0px; margin:0 auto; background:url(<?php echo $boder;?>) no-repeat top center;"></div>

<h1 style="width:100%; padding:0px 0px 30px 0px; margin:0px; color:#e4097f; font-size:30px; font-weight:bold; clear:both;text-align: center;">Hurry! grab the deal</h1>
</div>
<div style="clear:both"></div>
