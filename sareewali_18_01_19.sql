...
--
-- Host: 127.0.0.1
-- Generation Time: Jan 18, 2019 at 09:48 PM
...
(1, 'admin', 'contact@sareewali.com', 'JAvlGPq9JyTdtvBO6x2llnRI1+gxwIyPqCKAn3THIKk=', 'admin123', '8100 4444 11 ', '<p>Kolkata</p>\r\n', 1);
...
CREATE TABLE `saree_order` (
  ...
  `order_status` int(11) NOT NULL DEFAULT '1' COMMENT '1: Received, 2: Processed, 3: Dispatched, 4: Delivered',
  `date_added` int(11) NOT NULL,
  `date_modified` int(11) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
(1, 'SW-001', 'eZyX51Eg', 'Partha', 'Chowdhury', 'partha.freelancer.2015@gmail.com', '9089130313', '131 Landsdowne Ave', '', 'Westfield', '07090', 101, 1, '9,999.00', '999.90', '8,999.10', 'cod', 'N', 2, 0, 1, 1547751217, 0);
...
(1, 'Sareewali', 'http://www.sareewali.com/', 'logo.png', 'uploads/logo/logo.png', 'https://www.facebook.com/Sareewali-1848407462128165', 1535047808);
