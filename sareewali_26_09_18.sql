...
(6, 'Wholesale', '', '', 'wholesale', 1, 1, 4, 'Y', 'Y', 1534869170, 0),
(7, 'Lehenga', 'Pure Lehenga', '', 'lehenga', 1, 1, 0, 'N', 'Y', 1536740604, 0);
...
INSERT INTO `saree_product` (`product_id`, `name`, `description`, `slug`, `sku`, `quantity`, `price`, `out_of_stock`, `entity_id`, `status`, `date_added`, `date_modified`) VALUES
(1, 'KVA00001', '<ul>\r\n	<li>Lehenga in Pure Cloths</li>\r\n</ul>\r\n', 'kva00001', 'KVA00001', 1, 9999.00, 'N', 0, 'Y', 1536741513, 1537905215);
...
(1, '1.1.jpg', 'uploads/product/1.1.jpg', 1, 'f2d52e7a-ab5c-4f84-ad24-1fc8c3b884f6', 1, 'Y', 'Y'),
(2, '1.3.jpg', 'uploads/product/1.3.jpg', 1, '7d04b149-6b75-40bc-9da5-5be5047f35d3', 1, 'N', 'Y'),
(3, '1.2.jpg', 'uploads/product/1.2.jpg', 1, '910e332f-bac8-43c0-867d-3cbc92df3476', 1, 'N', 'Y'),
(4, '1.4.jpg', 'uploads/product/1.4.jpg', 1, '6b5f7181-81b4-4817-ba2a-4e10f6226f8d', 1, 'N', 'Y');
...
(2, 'Partha', 'Chowdhury', 'partha.freelancer.2015@gmail.com', '', '', '', '', '', '', 0, 0, 'Y', 1536088346, 1536088346, 0);
...
--
ALTER TABLE `saree_product_attribute`
  MODIFY `product_attribute_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
...
--
ALTER TABLE `saree_product_entity`
  MODIFY `saree_product_entity_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=18;
