...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 07, 2018 at 09:05 PM
...
(1, 'test1', '<p>test1</p>\r\n', 'test1', 'SKU-1', '', 1, 100.00, 'N', '', 0.00, 98.00, 'N', 'Y', 1538673124, 1538680587),
(2, 'test2', '<p>test2</p>\r\n', 'test2', 'SKU-2', '', 12, 4500.00, 'N', '', 0.00, 0.00, 'N', 'Y', 1538673172, 1538678565),
(3, 'test3', '<p>test3</p>\r\n', 'test3', 'SKU-3', '', 123, 8890.00, 'N', '', 0.00, 0.00, 'N', 'Y', 1538673217, 1538678555),
(4, 'test4', '<p>test4</p>\r\n', 'test4', 'SKU-4', '', 12, 8765.00, 'N', '', 0.00, 0.00, 'N', 'Y', 1538682694, 0),
(5, 'test5', '<p>test5</p>\r\n', 'test5', 'SKU-5', '', 32, 6543.00, 'N', '', 0.00, 0.00, 'N', 'Y', 1538682747, 0),
(6, 'test6', '<p>test6</p>\r\n', 'test6', 'SKU-6', '', 54, 6544.00, 'Y', 'flat', 100.00, 6444.00, 'N', 'Y', 1538682793, 1541590224),
(7, 'test7', '<p>test7</p>\r\n', 'test7', 'SKU-7', '', 2, 5556.00, 'N', '', 0.00, 0.00, 'N', 'Y', 1538682839, 1539114957),
(8, 'test8', '<p>test8</p>\r\n', 'test8', 'SKU-8', '', 43, 100.00, 'N', '', 0.00, 0.00, 'N', 'Y', 1538682880, 0),
(9, 'test10', '<p>test10</p>\r\n', 'test10', 'test10', '', 12, 88999.00, 'Y', 'per', 5.00, 84549.05, 'N', 'Y', 1541590302, 0),
(10, 'test11', '<p>test11</p>\r\n', 'test11', 'test11', 'Saree, Blouse', 132, 88.00, 'Y', 'per', 12.00, 77.44, 'N', 'Y', 1541607324, 1541619039),
...
--
ALTER TABLE `saree_product_color`
  MODIFY `product_color_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=41;
--
-- AUTO_INCREMENT for table `saree_product_entity`
--
ALTER TABLE `saree_product_entity`
  MODIFY `saree_product_entity_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=70;
--
-- AUTO_INCREMENT for table `saree_product_fabric`
--
ALTER TABLE `saree_product_fabric`
  MODIFY `product_fabric_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=15;
--
...
--
ALTER TABLE `saree_product_occassion`
  MODIFY `product_occassion_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=13;
--
-- AUTO_INCREMENT for table `saree_product_tags`
--
ALTER TABLE `saree_product_tags`
  MODIFY `product_tag_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=26;
--
