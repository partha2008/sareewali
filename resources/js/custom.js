		...
		if(PAGENAME == 'home'){
		    ...
		    $("img[alt='1']").hover(
		        function() {
		            ...
		            $("img[alt='1']").attr('src', 'images/star-on.png');
		            $("img[alt='2']").attr('src', 'images/star-off.png');
		            $("img[alt='3']").attr('src', 'images/star-off.png');
		            $("img[alt='4']").attr('src', 'images/star-off.png');
		            $("img[alt='5']").attr('src', 'images/star-off.png');
		        }
		    );
		    ...
		    $("img[alt='2']").hover(
		        function() {
		            var score_num = $('#score').val();
		            $("img[alt='1']").attr('src', 'images/star-on.png');
		            $("img[alt='2']").attr('src', 'images/star-on.png');
		            $("img[alt='3']").attr('src', 'images/star-off.png');
		            $("img[alt='4']").attr('src', 'images/star-off.png');
		            $("img[alt='5']").attr('src', 'images/star-off.png');
		        }
		    ...
		    $("img[alt='3']").hover(
		        function() {
		            ...
		            $("img[alt='1']").attr('src', 'images/star-on.png');
		            $("img[alt='2']").attr('src', 'images/star-on.png');
		            $("img[alt='3']").attr('src', 'images/star-on.png');
		            $("img[alt='4']").attr('src', 'images/star-off.png');
		            $("img[alt='5']").attr('src', 'images/star-off.png');
		        }
		    );
		    ...
		    $("img[alt='4']").hover(
		        function() {
		            ...
		            $("img[alt='2']").attr('src', 'images/star-on.png');
		            $("img[alt='3']").attr('src', 'images/star-on.png');
		            $("img[alt='4']").attr('src', 'images/star-on.png');
		            $("img[alt='5']").attr('src', 'images/star-off.png');
		        }
		    );
		    ...
		    $("img[alt='5']").hover(
		        function() {
		            ...
		            $("img[alt='3']").attr('src', 'images/star-on.png');
		            $("img[alt='4']").attr('src', 'images/star-on.png');
		            $("img[alt='5']").attr('src', 'images/star-on.png');
		        }
		    );
		    ...
		    $('#score-demo').mouseout(
		        function() {
		            ...
		            if (current_score > 0)
		            {
		                ...
		                {
		                    document.getElementById('star' + i).src = 'images/star-on.png';
		                }
		                for (var i = current_score + 1; i <= 5; i++)
		                {
		                    document.getElementById('star' + i).src = 'images/star-off.png';
		                }
		            } else
		            {
		                for (var i = 1; i <= 5; i++)
