...
--
-- Host: 127.0.0.1
-- Generation Time: Oct 30, 2018 at 08:18 PM
...
(1, 'test1', '<p>test1</p>\r\n', 'test1', 'SKU-1', 1, 100.00, 'N', 'Y', 1538673124, 1538680587),
(2, 'test2', '<p>test2</p>\r\n', 'test2', 'SKU-2', 12, 4500.00, 'N', 'Y', 1538673172, 1538678565),
(3, 'test3', '<p>test3</p>\r\n', 'test3', 'SKU-3', 123, 8890.00, 'N', 'Y', 1538673217, 1538678555),
(4, 'test4', '<p>test4</p>\r\n', 'test4', 'SKU-4', 12, 8765.00, 'N', 'Y', 1538682694, 0),
(5, 'test5', '<p>test5</p>\r\n', 'test5', 'SKU-5', 32, 6543.00, 'N', 'Y', 1538682747, 0),
(6, 'test6', '<p>test6</p>\r\n', 'test6', 'SKU-6', 54, 6544.00, 'N', 'Y', 1538682793, 1540494045),
(7, 'test7', '<p>test7</p>\r\n', 'test7', 'SKU-7', 2, 5556.00, 'N', 'Y', 1538682839, 1539114957),
(8, 'test8', '<p>test8</p>\r\n', 'test8', 'SKU-8', 43, 100.00, 'N', 'Y', 1538682880, 0);
...
INSERT INTO `saree_review` (`review_id`, `reviewer`, `email`, `phone`, `state_id`, `review`, `status`, `date_added`, `date_modified`) VALUES
(1, 'Partha Chowdhury', 'partha.freelancer.2015@gmail.com', '9089130313', 41, 'This is for test.', 'Y', 1540924618, 1540926844),
(2, 'Partha Chowdhury', 'partha.freelancer.2015@gmail.com', '90891303131', 40, 'This is for test.', 'Y', 1540926346, 0),
(3, 'Partha Chowdhury', 'partha.freelancer.2015@gmail.com', '9089130313', 40, 'This is for test.', 'Y', 1540926386, 0);
...
--
ALTER TABLE `saree_product_attribute`
  MODIFY `product_attribute_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;
--
-- AUTO_INCREMENT for table `saree_product_color`
--
ALTER TABLE `saree_product_color`
  MODIFY `product_color_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=26;
--
-- AUTO_INCREMENT for table `saree_product_entity`
--
ALTER TABLE `saree_product_entity`
  MODIFY `saree_product_entity_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=41;
--
-- AUTO_INCREMENT for table `saree_product_images`
--
ALTER TABLE `saree_product_images`
  MODIFY `product_image_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=12;
--
-- AUTO_INCREMENT for table `saree_product_tags`
--
ALTER TABLE `saree_product_tags`
  MODIFY `product_tag_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=19;
--
