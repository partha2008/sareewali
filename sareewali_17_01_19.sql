...
--
-- Host: 127.0.0.1
-- Generation Time: Jan 17, 2019 at 09:40 PM
...
INSERT INTO `saree_order` (`order_id`, `orderid`, `transaction_id`, `first_name`, `last_name`, `email`, `phone`, `address1`, `address2`, `city`, `post_code`, `country_id`, `state_id`, `sub_total`, `discount`, `grand_total`, `payment_type`, `invoice_generated`, `status`, `order_status`, `date_added`, `date_modified`) VALUES
(1, 'SW-001', 'eZyX51Eg', 'Partha', 'Chowdhury', 'partha.freelancer.2015@gmail.com', '9089130313', '131 Landsdowne Ave', '', 'Westfield', '07090', 101, 1, '9,999.00', '999.90', '8,999.10', 'cod', 'N', 0, 1, 1547751217, 0);
